...
The system SHALL allow users to register with username, password, and optional email.
...
### Requirement: Multiple Users Support

The system SHALL support multiple user accounts with separate scopes and permissions.

*Note: This requirement is being removed as v1.0 targets single-user (server owner) deployments.*
